# Contributing to TurboDev

This guide explains how to add features and blocks to TurboDev.
...
Add the method to TurboDev's class:
...
It is generally recommended to keep everything in `src/01-core.js` as that is how TurboDev was made.
